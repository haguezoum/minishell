...
/*   Updated: 2023/09/10 03:01:21 by haguezou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	process_operator(t_global **current_token, int *has_operator)
{
	t_global	*next_token;
...
int	process_token(t_global **current_token, int *has_operator, int *has_command,
		t_global **prev_word)
{
...
int	handle_pipe_line(int *has_operator, int *has_command)
{
...
int	handle_operator_case(t_global **current_token, int *has_operator,
		t_global **prev_word)
{
	int	result;
	...
	result = process_operator(current_token, has_operator);
